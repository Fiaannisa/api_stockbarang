...
insert  into `distributor`(`id_distributor`,`kode_distributor`,`nama_distributor`,`no_telp`,`alamat`) values (1,'DTB-0001','Asia Paramita Indah PT','0269002224','Jl. Perniagaan Brt 12 RT 012/01, Roa Malaka, Tambora, Jakarta Barat 11230 DKI JAKARTA'),(5,'DTB-0002','Flatloss Center','0216930209','Tambora, Jakarta Barat');
